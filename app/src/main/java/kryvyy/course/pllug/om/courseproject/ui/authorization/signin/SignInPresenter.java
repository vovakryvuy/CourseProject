...
public class SignInPresenter implements InterfaceSignIn.ContactSignInPresenter {
    private InterfaceSignIn.ContactSignInView mContactSignInView;
    private PreferencesSignIn mPref;
    private Context mContext;

    public SignInPresenter(InterfaceSignIn.ContactSignInView contactSignInView, Context context) {
